...
export async function render(outlet) {
  ...
  if (!all.length) { wrap.innerHTML = '<div class="empty rise"><p class="h3">No notes yet.</p><p>Project updates from the studio appear here.</p></div>'; return; }

  wrap.appendChild(el('<div class="rise"><span class="label section-label">Notes</span></div>'));

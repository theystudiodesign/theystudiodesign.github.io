...
export async function render(outlet) {
  ...
  if (!items.length) { wrap.innerHTML = '<div class="empty rise"><p class="h3">No deliverables yet.</p><p>Work shared for your review will appear here.</p></div>'; return; }

  wrap.appendChild(el('<div class="rise"><span class="label section-label">Deliverables</span></div>'));

...
- **Tests**: `tests/sync-v2.js` (28 ✓ — local, login sans écrasement, 2 appareils, soft-delete sans résurrection, offline→online, conflits updatedAt & delete-vs-edit, anti-résurrection, reprise de session) + `tests/acceptance.js` (scénario exact create/refresh/delete/refresh ×3, 4 environnements: **3 runs consécutifs 25 ✓/0 ✗**). SW v38 (précache les 5 modules).

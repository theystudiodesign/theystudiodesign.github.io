...
STRINGS = {
    ...
    'data-cursor-chip="Start this project →"': 'data-cursor-chip="ابدأ هذا المشروع →"',
    '>Your label —</span>': '>ملصقك —</span>',
    '>Your product here</h2>': '>منتجك هنا</h2>',
    'The first packaging case study is being written — it could be yours.': 'أول دراسة حالة للتغليف قيد الكتابة — قد تكون قصتك أنت.',
    ...
    "We do four things. We do them extremely well.": "نتقن أربعة أشياء. ونتقنها إتقانًا تامًا.",
    "Focus is a feature. By refusing to be a full-service everything-agency, we stay senior on every project, honest about what we’re not, and accountable for what we are: brand, web, packaging, and the visual voice that carries them all.":
        "التركيز ميزة. برفضنا أن نكون وكالة لكل شيء، نبقى رفيعي الخبرة في كل مشروع، صادقين بشأن ما لسنا عليه، ومسؤولين عمّا نحن عليه: العلامة، والويب، والتغليف، والصوت البصري الذي يحمل ذلك كله.",
    ...
    '<h2 class="pillar-title">Label &amp; Packaging</h2>': '<h2 class="pillar-title">الملصقات والتغليف</h2>',
    "Packaging that sells the product before it’s opened.": "تغليف يبيع المنتج قبل أن يُفتح.",
    "<li>Label design (single product)</li>": "<li>تصميم ملصق (منتج واحد)</li>",
    "<li>Range &amp; multi-product systems</li>": "<li>أنظمة تشكيلات متعددة المنتجات</li>",
    "<li>Packaging structure &amp; dielines</li>": "<li>هيكل التغليف وقوالب القصّ</li>",
    "<li>Legal mentions &amp; barcodes</li>": "<li>البيانات القانونية والباركود</li>",
    "<li>Print-ready files &amp; printer supervision</li>": "<li>ملفات جاهزة للطباعة ومتابعة المطبعة</li>",
    "<li>3D mockups &amp; e-commerce visuals</li>": "<li>موك-أب ثلاثي الأبعاد وصور للتجارة الإلكترونية</li>",
    "<strong>Ideal for:</strong> food &amp; terroir producers (olive oil, argan, honey, tea), cosmetics brands, and products moving from local shelves to retail chains and export.":
        "<strong>مثالي لـ:</strong> منتجي الأغذية ومنتجات المجال (زيت الزيتون، الأركان، العسل، الشاي)، علامات مستحضرات التجميل، والمنتجات المنتقلة من الرف المحلي إلى سلاسل التوزيع والتصدير.",
    "Designed for the shelf, built for the printer.": "مصمَّم للرف، مبنيّ للمطبعة.",
    ">Label &amp; Packaging</span>": ">الملصقات والتغليف</span>",
    "Labels and packaging that sell the product before it’s opened.": "ملصقات وتغليف تبيع المنتج قبل أن يُفتح.",
    '>Label &amp; Packaging</button>': '>الملصقات والتغليف</button>',
    ...
    "<li>Print &amp; editorial</li>": "<li>المطبوعات والإصدارات</li>",
    ...
    ">Packs — fixed scope, fixed price</h2>": ">باقات — نطاق ثابت، سعر ثابت</h2>",
    "<h3 class=\"pack-name\">Label Design</h3>": "<h3 class=\"pack-name\">تصميم الملصقات</h3>",
    "<h3 class=\"pack-name\">Packaging Design</h3>": "<h3 class=\"pack-name\">تصميم التغليف</h3>",
    "<h3 class=\"pack-name\">Product Launch Pack</h3>": "<h3 class=\"pack-name\">باقة إطلاق المنتج</h3>",
    "<span class=\"from\">From</span>": "<span class=\"from\">ابتداءً من</span>",
    "<span class=\"pack-tag\">Most popular</span>": "<span class=\"pack-tag\">الأكثر طلبًا</span>",
    "Start this pack <span": "ابدأ هذه الباقة <span",
    "Premium product label design focused on shelf impact, clarity and brand recognition.": "تصميم ملصقات منتجات راقٍ يركز على الحضور في الرف والوضوح وتميّز العلامة.",
    "Strategic packaging design that combines aesthetics, functionality and market positioning.": "تصميم تغليف استراتيجي يجمع بين الجمالية والوظيفة والتموضع في السوق.",
    "An end-to-end launch solution including brand identity, packaging, label design, print-ready files and launch assets.": "حل إطلاق متكامل يشمل هوية العلامة والتغليف وتصميم الملصق وملفات جاهزة للطباعة وأصول الإطلاق.",
    ...
    "Investment &amp; timing — roughly.": "الاستثمار والتوقيت — تقريبًا.",
    ">Investment range (DH)</p>": ">ميزانية الاستثمار (بالدرهم)</p>",
    '>3&nbsp;000 – 6&nbsp;000&nbsp;DH</button>': '>3&nbsp;000 – 6&nbsp;000 درهم</button>',
    '>6&nbsp;000 – 10&nbsp;000&nbsp;DH</button>': '>6&nbsp;000 – 10&nbsp;000 درهم</button>',
    '>10&nbsp;000 – 20&nbsp;000&nbsp;DH</button>': '>10&nbsp;000 – 20&nbsp;000 درهم</button>',
    '>20&nbsp;000&nbsp;DH +</button>': '>أكثر من 20&nbsp;000 درهم</button>',
    '>Let’s discuss</button>': '>لست متأكدًا</button>',
    ...
    "And you are?": "ومن أنت؟",
    ">Selected pack:</span>": ">الباقة المختارة:</span>",
    ">Label Design — from 800 DH<": ">تصميم الملصقات — ابتداءً من 800 درهم<",
    ">Packaging Design — from 1,500 DH<": ">تصميم التغليف — ابتداءً من 1,500 درهم<",
    ">Product Launch Pack — from 5,500 DH<": ">باقة إطلاق المنتج — ابتداءً من 5,500 درهم<",
    "Fixed scope, fixed price — just tell us who you are.": "نطاق ثابت وسعر ثابت — فقط عرّفنا بنفسك.",

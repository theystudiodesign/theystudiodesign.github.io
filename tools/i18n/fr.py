...
STRINGS = {
    ...
    'data-cursor-chip="Start this project →"': 'data-cursor-chip="Lancer ce projet →"',
    '>Your label —</span>': '>Votre étiquette —</span>',
    '>Your product here</h2>': '>Votre produit ici</h2>',
    'The first packaging case study is being written — it could be yours.': 'La première étude de cas packaging s’écrit en ce moment — elle pourrait être la vôtre.',
    ...
    "We do four things. We do them extremely well.": "Nous faisons quatre choses. Nous les faisons extrêmement bien.",
    "Focus is a feature. By refusing to be a full-service everything-agency, we stay senior on every project, honest about what we’re not, and accountable for what we are: brand, web, packaging, and the visual voice that carries them all.":
        "La spécialisation est une force. En refusant d’être une agence à tout faire, nous restons seniors sur chaque projet, honnêtes sur ce que nous ne sommes pas, et responsables de ce que nous sommes\u00A0: la marque, le web, le packaging, et la voix visuelle qui porte le tout.",
    ...
    '<h2 class="pillar-title">Label &amp; Packaging</h2>': '<h2 class="pillar-title">Étiquettes &amp; Packaging</h2>',
    "Packaging that sells the product before it’s opened.": "Un packaging qui vend le produit avant même qu’on l’ouvre.",
    "<li>Label design (single product)</li>": "<li>Design d’étiquette (produit unique)</li>",
    "<li>Range &amp; multi-product systems</li>": "<li>Systèmes de gamme multi-produits</li>",
    "<li>Packaging structure &amp; dielines</li>": "<li>Structure packaging &amp; gabarits de découpe</li>",
    "<li>Legal mentions &amp; barcodes</li>": "<li>Mentions légales &amp; codes-barres</li>",
    "<li>Print-ready files &amp; printer supervision</li>": "<li>Fichiers prêts à imprimer &amp; suivi imprimeur</li>",
    "<li>3D mockups &amp; e-commerce visuals</li>": "<li>Mockups 3D &amp; visuels e-commerce</li>",
    "<strong>Ideal for:</strong> food &amp; terroir producers (olive oil, argan, honey, tea), cosmetics brands, and products moving from local shelves to retail chains and export.":
        "<strong>Idéal pour :</strong> producteurs agroalimentaires et du terroir (huile d’olive, argan, miel, thé), marques de cosmétiques, et produits qui passent du rayon local à la grande distribution et à l’export.",
    "Designed for the shelf, built for the printer.": "Pensé pour le rayon, construit pour l’imprimeur.",
    ">Label &amp; Packaging</span>": ">Étiquettes &amp; Packaging</span>",
    "Labels and packaging that sell the product before it’s opened.": "Des étiquettes et un packaging qui vendent le produit avant même qu’on l’ouvre.",
    '>Label &amp; Packaging</button>': '>Étiquettes &amp; Packaging</button>',
    ...
    "<li>Print &amp; editorial</li>": "<li>Print &amp; éditorial</li>",
    ...
    "<h3 class=\"pack-name\">Label Design</h3>": "<h3 class=\"pack-name\">Design d’étiquette</h3>",
    "<h3 class=\"pack-name\">Packaging Design</h3>": "<h3 class=\"pack-name\">Design de packaging</h3>",
    "<h3 class=\"pack-name\">Product Launch Pack</h3>": "<h3 class=\"pack-name\">Pack Lancement Produit</h3>",
    "<span class=\"from\">From</span>": "<span class=\"from\">À partir de</span>",
    "<span class=\"pack-tag\">Most popular</span>": "<span class=\"pack-tag\">Le plus demandé</span>",
    "Start this pack <span": "Lancer ce pack <span",
    ...
    "Investment &amp; timing — roughly.": "Investissement &amp; délais — en gros.",
    ">Investment range (DH)</p>": ">Budget d’investissement (DH)</p>",
    ...
    ">Selected pack:</span>": ">Pack choisi :</span>",
    ">Label Design — from 800 DH<": ">Design d’étiquette — à partir de 800 DH<",
    ">Packaging Design — from 1,500 DH<": ">Design de packaging — à partir de 1 500 DH<",
    ">Product Launch Pack — from 5,500 DH<": ">Pack Lancement Produit — à partir de 5 500 DH<",
    "Fixed scope, fixed price — just tell us who you are.": "Périmètre fixe, prix fixe — dites-nous simplement qui vous êtes.",
